...
module nios_cpu_mm_interconnect_0 (
		...
		output wire [1:0]  push_btns_s1_address,                       //                         push_btns_s1.address
		output wire        push_btns_s1_write,                         //                                     .write
		input  wire [31:0] push_btns_s1_readdata,                      //                                     .readdata
		output wire [31:0] push_btns_s1_writedata,                     //                                     .writedata
		output wire        push_btns_s1_chipselect,                    //                                     .chipselect
	...
	wire  [96:0] nios_cpu_debug_mem_slave_agent_rf_source_data;                                  // nios_cpu_debug_mem_slave_agent:rf_source_data -> nios_cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] nios_cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios_cpu_debug_mem_slave_agent_rsp_fifo:out_data -> nios_cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                          // cmd_mux_002:src_valid -> nios_cpu_debug_mem_slave_agent:cp_valid
	wire  [95:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> nios_cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // nios_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [7:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> nios_cpu_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                  // cmd_mux_002:src_startofpacket -> nios_cpu_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                    // cmd_mux_002:src_endofpacket -> nios_cpu_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [19:0] led_green_s1_agent_m0_address;                                                  // led_green_s1_agent:m0_address -> led_green_s1_translator:uav_address
	...
	wire  [96:0] led_green_s1_agent_rf_source_data;                                              // led_green_s1_agent:rf_source_data -> led_green_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] led_green_s1_agent_rsp_fifo_out_data;                                           // led_green_s1_agent_rsp_fifo:out_data -> led_green_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                          // cmd_mux_003:src_valid -> led_green_s1_agent:cp_valid
	wire  [95:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> led_green_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                          // led_green_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> led_green_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                  // cmd_mux_003:src_startofpacket -> led_green_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                    // cmd_mux_003:src_endofpacket -> led_green_s1_agent:cp_endofpacket
	...
	wire   [7:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [19:0] led_red_s1_agent_m0_address;                                                    // led_red_s1_agent:m0_address -> led_red_s1_translator:uav_address
	...
	wire  [96:0] led_red_s1_agent_rf_source_data;                                                // led_red_s1_agent:rf_source_data -> led_red_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] led_red_s1_agent_rsp_fifo_out_data;                                             // led_red_s1_agent_rsp_fifo:out_data -> led_red_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                          // cmd_mux_005:src_valid -> led_red_s1_agent:cp_valid
	wire  [95:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> led_red_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                          // led_red_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                        // cmd_mux_005:src_channel -> led_red_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                  // cmd_mux_005:src_startofpacket -> led_red_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                    // cmd_mux_005:src_endofpacket -> led_red_s1_agent:cp_endofpacket
	...
	wire  [31:0] push_btns_s1_agent_m0_readdata;                                                 // push_btns_s1_translator:uav_readdata -> push_btns_s1_agent:m0_readdata
	wire         push_btns_s1_agent_m0_waitrequest;                                              // push_btns_s1_translator:uav_waitrequest -> push_btns_s1_agent:m0_waitrequest
	wire         push_btns_s1_agent_m0_debugaccess;                                              // push_btns_s1_agent:m0_debugaccess -> push_btns_s1_translator:uav_debugaccess
	wire  [19:0] push_btns_s1_agent_m0_address;                                                  // push_btns_s1_agent:m0_address -> push_btns_s1_translator:uav_address
	wire   [3:0] push_btns_s1_agent_m0_byteenable;                                               // push_btns_s1_agent:m0_byteenable -> push_btns_s1_translator:uav_byteenable
	wire         push_btns_s1_agent_m0_read;                                                     // push_btns_s1_agent:m0_read -> push_btns_s1_translator:uav_read
	wire         push_btns_s1_agent_m0_readdatavalid;                                            // push_btns_s1_translator:uav_readdatavalid -> push_btns_s1_agent:m0_readdatavalid
	wire         push_btns_s1_agent_m0_lock;                                                     // push_btns_s1_agent:m0_lock -> push_btns_s1_translator:uav_lock
	wire  [31:0] push_btns_s1_agent_m0_writedata;                                                // push_btns_s1_agent:m0_writedata -> push_btns_s1_translator:uav_writedata
	wire         push_btns_s1_agent_m0_write;                                                    // push_btns_s1_agent:m0_write -> push_btns_s1_translator:uav_write
	wire   [2:0] push_btns_s1_agent_m0_burstcount;                                               // push_btns_s1_agent:m0_burstcount -> push_btns_s1_translator:uav_burstcount
	wire         push_btns_s1_agent_rf_source_valid;                                             // push_btns_s1_agent:rf_source_valid -> push_btns_s1_agent_rsp_fifo:in_valid
	wire  [96:0] push_btns_s1_agent_rf_source_data;                                              // push_btns_s1_agent:rf_source_data -> push_btns_s1_agent_rsp_fifo:in_data
	wire         push_btns_s1_agent_rf_source_ready;                                             // push_btns_s1_agent_rsp_fifo:in_ready -> push_btns_s1_agent:rf_source_ready
	wire         push_btns_s1_agent_rf_source_startofpacket;                                     // push_btns_s1_agent:rf_source_startofpacket -> push_btns_s1_agent_rsp_fifo:in_startofpacket
	wire         push_btns_s1_agent_rf_source_endofpacket;                                       // push_btns_s1_agent:rf_source_endofpacket -> push_btns_s1_agent_rsp_fifo:in_endofpacket
	wire         push_btns_s1_agent_rsp_fifo_out_valid;                                          // push_btns_s1_agent_rsp_fifo:out_valid -> push_btns_s1_agent:rf_sink_valid
	wire  [96:0] push_btns_s1_agent_rsp_fifo_out_data;                                           // push_btns_s1_agent_rsp_fifo:out_data -> push_btns_s1_agent:rf_sink_data
	wire         push_btns_s1_agent_rsp_fifo_out_ready;                                          // push_btns_s1_agent:rf_sink_ready -> push_btns_s1_agent_rsp_fifo:out_ready
	wire         push_btns_s1_agent_rsp_fifo_out_startofpacket;                                  // push_btns_s1_agent_rsp_fifo:out_startofpacket -> push_btns_s1_agent:rf_sink_startofpacket
	wire         push_btns_s1_agent_rsp_fifo_out_endofpacket;                                    // push_btns_s1_agent_rsp_fifo:out_endofpacket -> push_btns_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                          // cmd_mux_007:src_valid -> push_btns_s1_agent:cp_valid
	wire  [95:0] cmd_mux_007_src_data;                                                           // cmd_mux_007:src_data -> push_btns_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                          // push_btns_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                        // cmd_mux_007:src_channel -> push_btns_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                  // cmd_mux_007:src_startofpacket -> push_btns_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                    // cmd_mux_007:src_endofpacket -> push_btns_s1_agent:cp_endofpacket
	wire         nios_cpu_data_master_agent_cp_valid;                                            // nios_cpu_data_master_agent:cp_valid -> router:sink_valid
	wire  [95:0] nios_cpu_data_master_agent_cp_data;                                             // nios_cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [95:0] nios_cpu_instruction_master_agent_cp_data;                                      // nios_cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         nios_cpu_debug_mem_slave_agent_rp_valid;                                        // nios_cpu_debug_mem_slave_agent:rp_valid -> router_004:sink_valid
	wire  [95:0] nios_cpu_debug_mem_slave_agent_rp_data;                                         // nios_cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	wire         nios_cpu_debug_mem_slave_agent_rp_ready;                                        // router_004:sink_ready -> nios_cpu_debug_mem_slave_agent:rp_ready
	wire         nios_cpu_debug_mem_slave_agent_rp_startofpacket;                                // nios_cpu_debug_mem_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         nios_cpu_debug_mem_slave_agent_rp_endofpacket;                                  // nios_cpu_debug_mem_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [95:0] led_green_s1_agent_rp_data;                                                     // led_green_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] led_red_s1_agent_rp_data;                                                       // led_red_s1_agent:rp_data -> router_007:sink_data
	...
	wire         push_btns_s1_agent_rp_valid;                                                    // push_btns_s1_agent:rp_valid -> router_009:sink_valid
	wire  [95:0] push_btns_s1_agent_rp_data;                                                     // push_btns_s1_agent:rp_data -> router_009:sink_data
	wire         push_btns_s1_agent_rp_ready;                                                    // router_009:sink_ready -> push_btns_s1_agent:rp_ready
	wire         push_btns_s1_agent_rp_startofpacket;                                            // push_btns_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         push_btns_s1_agent_rp_endofpacket;                                              // push_btns_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         router_src_valid;                                                               // router:src_valid -> nios_cpu_data_master_limiter:cmd_sink_valid
	wire  [95:0] router_src_data;                                                                // router:src_data -> nios_cpu_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                               // nios_cpu_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [7:0] router_src_channel;                                                             // router:src_channel -> nios_cpu_data_master_limiter:cmd_sink_channel
	wire         router_src_startofpacket;                                                       // router:src_startofpacket -> nios_cpu_data_master_limiter:cmd_sink_startofpacket
	wire         router_src_endofpacket;                                                         // router:src_endofpacket -> nios_cpu_data_master_limiter:cmd_sink_endofpacket
	wire  [95:0] nios_cpu_data_master_limiter_cmd_src_data;                                      // nios_cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios_cpu_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> nios_cpu_data_master_limiter:cmd_src_ready
	wire   [7:0] nios_cpu_data_master_limiter_cmd_src_channel;                                   // nios_cpu_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire         nios_cpu_data_master_limiter_cmd_src_startofpacket;                             // nios_cpu_data_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire         nios_cpu_data_master_limiter_cmd_src_endofpacket;                               // nios_cpu_data_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire         rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> nios_cpu_data_master_limiter:rsp_sink_valid
	wire  [95:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> nios_cpu_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                              // nios_cpu_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [7:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> nios_cpu_data_master_limiter:rsp_sink_channel
	wire         rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> nios_cpu_data_master_limiter:rsp_sink_startofpacket
	wire         rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> nios_cpu_data_master_limiter:rsp_sink_endofpacket
	...
	wire  [95:0] nios_cpu_data_master_limiter_rsp_src_data;                                      // nios_cpu_data_master_limiter:rsp_src_data -> nios_cpu_data_master_agent:rp_data
	...
	wire   [7:0] nios_cpu_data_master_limiter_rsp_src_channel;                                   // nios_cpu_data_master_limiter:rsp_src_channel -> nios_cpu_data_master_agent:rp_channel
	...
	wire         router_001_src_valid;                                                           // router_001:src_valid -> nios_cpu_instruction_master_limiter:cmd_sink_valid
	wire  [95:0] router_001_src_data;                                                            // router_001:src_data -> nios_cpu_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                           // nios_cpu_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [7:0] router_001_src_channel;                                                         // router_001:src_channel -> nios_cpu_instruction_master_limiter:cmd_sink_channel
	wire         router_001_src_startofpacket;                                                   // router_001:src_startofpacket -> nios_cpu_instruction_master_limiter:cmd_sink_startofpacket
	wire         router_001_src_endofpacket;                                                     // router_001:src_endofpacket -> nios_cpu_instruction_master_limiter:cmd_sink_endofpacket
	wire  [95:0] nios_cpu_instruction_master_limiter_cmd_src_data;                               // nios_cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire         nios_cpu_instruction_master_limiter_cmd_src_ready;                              // cmd_demux_001:sink_ready -> nios_cpu_instruction_master_limiter:cmd_src_ready
	wire   [7:0] nios_cpu_instruction_master_limiter_cmd_src_channel;                            // nios_cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire         nios_cpu_instruction_master_limiter_cmd_src_startofpacket;                      // nios_cpu_instruction_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire         nios_cpu_instruction_master_limiter_cmd_src_endofpacket;                        // nios_cpu_instruction_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire         rsp_mux_001_src_valid;                                                          // rsp_mux_001:src_valid -> nios_cpu_instruction_master_limiter:rsp_sink_valid
	wire  [95:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> nios_cpu_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                          // nios_cpu_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [7:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> nios_cpu_instruction_master_limiter:rsp_sink_channel
	wire         rsp_mux_001_src_startofpacket;                                                  // rsp_mux_001:src_startofpacket -> nios_cpu_instruction_master_limiter:rsp_sink_startofpacket
	wire         rsp_mux_001_src_endofpacket;                                                    // rsp_mux_001:src_endofpacket -> nios_cpu_instruction_master_limiter:rsp_sink_endofpacket
	...
	wire  [95:0] nios_cpu_instruction_master_limiter_rsp_src_data;                               // nios_cpu_instruction_master_limiter:rsp_src_data -> nios_cpu_instruction_master_agent:rp_data
	...
	wire   [7:0] nios_cpu_instruction_master_limiter_rsp_src_channel;                            // nios_cpu_instruction_master_limiter:rsp_src_channel -> nios_cpu_instruction_master_agent:rp_channel
	...
	wire   [7:0] nios_cpu_data_master_limiter_cmd_valid_data;                                    // nios_cpu_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [7:0] nios_cpu_instruction_master_limiter_cmd_valid_data;                             // nios_cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         nios_cpu_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios_cpu_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] nios_cpu_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios_cpu_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         nios_cpu_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_002:in_0_ready -> nios_cpu_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                              // avalon_st_adapter_002:out_0_valid -> nios_cpu_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                               // avalon_st_adapter_002:out_0_data -> nios_cpu_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                              // nios_cpu_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                              // avalon_st_adapter_002:out_0_error -> nios_cpu_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         led_green_s1_agent_rdata_fifo_src_valid;                                        // led_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] led_green_s1_agent_rdata_fifo_src_data;                                         // led_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         led_green_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> led_green_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                              // avalon_st_adapter_003:out_0_valid -> led_green_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                               // avalon_st_adapter_003:out_0_data -> led_green_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                              // led_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                              // avalon_st_adapter_003:out_0_error -> led_green_s1_agent:rdata_fifo_sink_error
	...
	wire         led_red_s1_agent_rdata_fifo_src_valid;                                          // led_red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] led_red_s1_agent_rdata_fifo_src_data;                                           // led_red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         led_red_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_005:in_0_ready -> led_red_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                              // avalon_st_adapter_005:out_0_valid -> led_red_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                               // avalon_st_adapter_005:out_0_data -> led_red_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                              // led_red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                              // avalon_st_adapter_005:out_0_error -> led_red_s1_agent:rdata_fifo_sink_error
	...
	wire         push_btns_s1_agent_rdata_fifo_src_valid;                                        // push_btns_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] push_btns_s1_agent_rdata_fifo_src_data;                                         // push_btns_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         push_btns_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_007:in_0_ready -> push_btns_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                              // avalon_st_adapter_007:out_0_valid -> push_btns_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                               // avalon_st_adapter_007:out_0_data -> push_btns_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                              // push_btns_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                              // avalon_st_adapter_007:out_0_error -> push_btns_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) push_btns_s1_translator (
		.clk                    (clk_50_clk_clk),                             //                      clk.clk
		.reset                  (nios_cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (push_btns_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (push_btns_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (push_btns_s1_agent_m0_read),                 //                         .read
		.uav_write              (push_btns_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (push_btns_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (push_btns_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (push_btns_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (push_btns_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (push_btns_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (push_btns_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (push_btns_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (push_btns_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (push_btns_s1_write),                         //                         .write
		.av_readdata            (push_btns_s1_readdata),                      //                         .readdata
		.av_writedata           (push_btns_s1_writedata),                     //                         .writedata
		.av_chipselect          (push_btns_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
		.av_beginbursttransfer  (),                                           //              (terminated)
		.av_burstcount          (),                                           //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_50_clk_clk),                                //             clk.clk
		.reset                   (nios_cpu_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (push_btns_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (push_btns_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (push_btns_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (push_btns_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (push_btns_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (push_btns_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (push_btns_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (push_btns_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (push_btns_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (push_btns_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (push_btns_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (push_btns_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (push_btns_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (push_btns_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (push_btns_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (push_btns_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (push_btns_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (push_btns_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (push_btns_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (push_btns_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (push_btns_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (push_btns_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (push_btns_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (push_btns_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (push_btns_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (push_btns_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),             //                .error
		.rdata_fifo_src_ready    (push_btns_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (push_btns_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (push_btns_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) push_btns_s1_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                //       clk.clk
		.reset             (nios_cpu_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (push_btns_s1_agent_rf_source_data),             //        in.data
		.in_valid          (push_btns_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (push_btns_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (push_btns_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (push_btns_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (push_btns_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (push_btns_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (push_btns_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (push_btns_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (push_btns_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	nios_cpu_mm_interconnect_0_router_004 router_006 (
	...
	nios_cpu_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (push_btns_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (push_btns_s1_agent_rp_valid),                //          .valid
		.sink_data          (push_btns_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (push_btns_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (push_btns_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_50_clk_clk),                             //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios_cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (push_btns_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (push_btns_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (push_btns_s1_agent_rdata_fifo_src_ready),    //         .ready
